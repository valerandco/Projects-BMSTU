  ...
  let carouselItems = [
    { 
      ...
      position: {
        top: '15%',
        left: '5%',  
        classPos: '8k:py-[300px] 8k:pl-[0px] 4k:pt-[320px] 4k:pl-[0px] 2k:pt-[170px] 2k:pl-[0px] xl:pt-32 xl:pl-[1px] lg:pt-[100px] lg:pl-[1px] md:pt-[50px] md:pl-[0px] sm:pt-[30px] sm:pl-[5px] xsm:pt-[15px] xsm:pl-[10px]',  
      },
    ...
    { 
      ...
      position: {
        ...
        classPos: '8k:mt-1980px] 4k:pt-[780px] 2k:pt-[400px] xl:pt-[250px] xl:pl-[10px] lg:pt-[170px] lg:pl-[10px] md:pt-[90px] md:pl-[1px] sm:pt-[70px] sm:pl-[1px] xsm:pt-[30px] xsm:pl-[1px]',  
      },
...
<header title="Esc" class="w-full h-10">
  <nav>
    <a id="about-link" href="javascript:void(0);">Page</a>
  </nav>
</header>
  ...
  <div class="w-full h-full absolute">
    <div class=" w-full h-full absolute">
      {#if mainImageIndex === carouselItems.length - 1 && carouselItems[mainImageIndex].video}
        ...
        <div class="video-container w-full sm:h-[100px] lg:h-[300px] xl:h-[500px] ">
          <iframe
            title="video"
            class="w-full h-full sm:h-[290px] md:h-[350px] lg:h-[482px] xl:h-[570px] 2k:h-[870px] 4k:h-[1750px] 8k:h-[3470px]"
    ...
    <div class="w-full h-full absolute flex flex-col items-center justify-end">
      {#each carouselItems as { text, position, logo, platforms }, index (text)}
        {#if index === mainImageIndex}
          ...
          <div class="w-[37px] h-[67px] p-2.5 opacity-95 rounded-[20px] flex items-center justify-center whitespace-nowrap mb-[80px] 8k:mb-[110px] 4k:mb-[100px] 2k:mb-[60px] xl:mb-[0px] md:mb-[80px] sm:mb-[65px]">
            <div class="text-white text-[28px] 8k:text-[200px] 4k:text-[75px] 2k:text-[32px] xl:text-[24px] lg:text-xl md:text-xl sm:text-[17px] font-normal font-['Inter'] leading-[23px] whitespace-nowrap 8k:mb-[420px] 4k:mb-[120px] 4k:pl-[100px] xl:mt-[10px] xsm:hidden sm:block md:block lg:block xl:block 2k:block 4k:block 8k:block ">Buy it for</div>
        ...
        >
          {#each carouselItems as { image }, index (image)}
            <div 
              role="button"
              tabindex="0"
              class="{ 'w-[50px] h-[9px] 8k:w-[350px] 8k:h-[50px] 8k:mx-[20px] 4k:w-[140px] 4k:h-[25px] 4k:mx-[10px] 2k:w-[60px] 2k:h-[10px] xl:w-[50px] xl:h-[9px] md:w-[40px] md:h-[7px] xsm:w-[30px] xsm:h-[8px] mx-1 transition duration-300 ease-in-out cursor-pointer mb-[170px] ' + (index === mainImageIndex ? 'bg-white rounded-sm' : 'bg-zinc-400 rounded-sm') }"
      ...
      <button on:click={prevImage} class="arrow-button left h-full pl-4 xl:pb-[100px] lg:pb-[120px] sm:pb-[250px] 2k:pl-[27px] sm:pl-[2px]">
      ...
      <button on:click={nextImage} class="arrow-button right h-full pr-4 xl:pb-[100px] lg:pb-[120px] sm:pb-[250px] 2k:pr-[27px] sm:pr-[2px]">
